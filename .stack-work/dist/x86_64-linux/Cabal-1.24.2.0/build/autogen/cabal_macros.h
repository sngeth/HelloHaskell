...
/* package HelloHaskell-0.1.0.0 */
#define VERSION_HelloHaskell "0.1.0.0"
#define MIN_VERSION_HelloHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "HelloHaskell-0.1.0.0-76qgaguAzZIJG6rGeWCh4M"

#define CURRENT_PACKAGE_KEY "HelloHaskell-0.1.0.0-76qgaguAzZIJG6rGeWCh4M"
